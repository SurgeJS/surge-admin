import { ResponsiveValue } from '@/components/common/Grid/types'
import AppConstant from '@/constant/app.ts'
import { isObject } from 'es-toolkit/compat'

const useResponsivePropsValue  = <K extends Recordable> (width: Ref<number>, data: K, key: keyof K) => {
...
export default useResponsivePropsValue