...
import {
  ...
  UnwrapGroupSchema
} from '@/components/common/SchemaForm/types/group.ts'
...
const handleGroupHide = (config: UnwrapGroupSchema) => {
  let isHide = true
...
// 展开收起文案
const getGroupExpandCollapseText = (config: UnwrapGroupSchema) => {
  return {
